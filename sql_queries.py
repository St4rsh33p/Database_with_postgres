...
songplay_table_create = ("CREATE TABLE songplays ( songplay_id serial PRIMARY KEY, start_time timestamp NOT NULL, \
...
user_table_create = ("CREATE TABLE users ( user_id int PRIMARY KEY, first_name varchar NOT NULL, \
last_name varchar NOT NULL, gender char(1) NOT NULL, level varchar NOT NULL )")

song_table_create = ("CREATE TABLE songs ( song_id varchar PRIMARY KEY, title varchar NOT NULL, \
artist_id varchar NOT NULL, year int NOT NULL, duration numeric NOT NULL )")

artist_table_create = ("CREATE TABLE artists (artist_id varchar PRIMARY KEY, name varchar NOT NULL, \
location varchar NOT NULL, latitude numeric, longitude numeric)")

time_table_create = ("CREATE TABLE time ( start_time timestamp PRIMARY KEY, hour int NOT NULL, day int NOT NULL, \
